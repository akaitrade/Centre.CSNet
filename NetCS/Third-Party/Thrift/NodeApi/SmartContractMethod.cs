              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SmartContractMethodArgument _elem108;
                    _elem108 = new SmartContractMethodArgument();
                    _elem108.Read(iprot);
                    Arguments.Add(_elem108);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (Arguments != null && __isset.arguments) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SmartContractMethodArgument _iter109 in Arguments)
            {
