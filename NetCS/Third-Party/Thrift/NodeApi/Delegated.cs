              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    DelegatedItem _elem30;
                    _elem30 = new DelegatedItem();
                    _elem30.Read(iprot);
                    Donors.Add(_elem30);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    DelegatedItem _elem33;
                    _elem33 = new DelegatedItem();
                    _elem33.Read(iprot);
                    Recipients.Add(_elem33);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (Donors != null && __isset.donors) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (DelegatedItem _iter34 in Donors)
            {
              _iter34.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (Recipients != null && __isset.recipients) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (DelegatedItem _iter35 in Recipients)
            {
              _iter35.Write(oprot);
            }
            oprot.WriteListEnd();
