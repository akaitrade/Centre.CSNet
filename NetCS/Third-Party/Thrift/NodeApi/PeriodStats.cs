              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  {
                    sbyte _key38;
                    CumulativeAmount _val39;
                    _key38 = iprot.ReadByte();
                    _val39 = new CumulativeAmount();
                    _val39.Read(iprot);
                    BalancePerCurrency[_key38] = _val39;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (BalancePerCurrency != null && __isset.balancePerCurrency) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (sbyte _iter40 in BalancePerCurrency.Keys)
            {
              oprot.WriteByte(_iter40);
              BalancePerCurrency[_iter40].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
